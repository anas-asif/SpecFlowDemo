@Marketing
Feature: Marketing
	This feature file covers the scenarios related to marketing area

@ignore @Contacts
Scenario: 01 User is able to view Lead Contact List
	Given User is Logged in
	And User Clicks on Contacts from left menu under Marketing heading
...
Scenario: 05 User is able to view My Open Leads List
	Given User is Logged in
	And User Clicks on Leads from left menu under Marketing heading
